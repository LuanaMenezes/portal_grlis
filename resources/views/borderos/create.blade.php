    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="pe-7s-pen text-info">
                </i>
            </div>
            <div style="margin-top: 25px;"><strong>Novo Borderô </strong>
                <p style="font-size:16px;"><em>Inserção Manual</em></p>
            </div>
        </div>
    </div>
    @if($errors->any())
...
<div class="tab-content">
    ...
    <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <form action="{{ route('borderos.store') }}" method="post" class="needs-validation" novalidate
                    ...
                    <input type="file" class="multi" name="arquivo[]" multiple="multiple" accept="application/pdf,application/vnd.ms-excel,
                    image/x-png,image/jpeg, application/xml"/>
